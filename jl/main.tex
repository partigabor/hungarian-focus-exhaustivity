...
To test this, and to address the theoretical debate and in line with recent experimental studies \citep{onea_2009_hungarian,gerocs_2014_exhaustivity,kaldi_2021_hungarian_structural}, we designed an experiment to investigate how Hungarian speakers interpret pre-verbal focus (PVF), and in particular, whether they distinguish between exhaustive and contrastive focus. Specifically, we aim at answering the following questions: What is the default interpretation of a pre-verbal focus construction? Is it really inherently exhaustive, or could it be contrastive?
...
The experiment was created, hosted on, and presented to participants on PCIbex Farm \citep{schwarz_2021_tutorial},\footnote{Code and resources are also available online for inspection: \href{https://osf.io/j9abg/overview?view_only=484a4f21a5cb4e51b4b826f970e096a0}{\url{https://osf.io/j9abg/overview?view_only=484a4f21a5cb4e51b4b826f970e096a}}} in Hungarian. Participants completed the experiment on their own devices (PC only, with a webcam and physical keyboard \& mouse) and on their own time, but with Prolific helping us control for too fast or too slow submissions resulting in rejection/timeout.
...
For sentence reading times, the Type III Wald chi-square tests l showed a significant main effect of Condition, $\chi^2(2)=18.66$, $p<.001$, but no main effect of Choice, $\chi^2(1)=0.06$, $p=.806$, and no interaction between Condition and Choice, $\chi^2(2)=2.10$, $p=.351$, (see Table~\ref{tab:sentence-rt}). This suggests that the different focus conditions had a significant impact on the overall reading times of the sentences, but the type of choice participants made (single-object vs multi-object) did not significantly affect their reading times. In other words, while the focus type influenced how long participants took to read the sentences, it did not seem to influence their decision-making process in terms of which image they chose, nor did the choice they made influence their reading times in a way that interacted with the condition. 
...
\# & A & B & \# & A & B \\
1 & \includegraphics[height=.096\textheight]{../plots/1a.png}  &
\includegraphics[height=.096\textheight]{../plots/1b.png}  &
2 & \includegraphics[height=.096\textheight]{../plots/2a.png}  &
\includegraphics[height=.096\textheight]{../plots/2b.png}  \\
3 &\includegraphics[height=.096\textheight]{../plots/3a.png}  &
\includegraphics[height=.096\textheight]{../plots/3b.png}  &
4 & \includegraphics[height=.096\textheight]{../plots/4a.png}  &
\includegraphics[height=.096\textheight]{../plots/4b.png}  \\
5 & \includegraphics[height=.096\textheight]{../plots/5a.png}  &
\includegraphics[height=.096\textheight]{../plots/5b.png}  &
6 & \includegraphics[height=.096\textheight]{../plots/6a.png}  &
\includegraphics[height=.096\textheight]{../plots/6b.png}  \\
7 & \includegraphics[height=.096\textheight]{../plots/7a.png}  &
\includegraphics[height=.096\textheight]{../plots/7b.png}  &
8 & \includegraphics[height=.096\textheight]{../plots/8a.png}  &
\includegraphics[height=.096\textheight]{../plots/8b.png}  \\
9 & \includegraphics[height=.096\textheight]{../plots/9a.png}  &
\includegraphics[height=.096\textheight]{../plots/9b.png}  &
10 & \includegraphics[height=.096\textheight]{../plots/10a.png} &
\includegraphics[height=.096\textheight]{../plots/10b.png} \\
11 & \includegraphics[height=.096\textheight]{../plots/11a.png} &
\includegraphics[height=.096\textheight]{../plots/11b.png} &
12 & \includegraphics[height=.096\textheight]{../plots/12a.png} &
\includegraphics[height=.096\textheight]{../plots/12b.png} \\
13 & \includegraphics[height=.096\textheight]{../plots/13a.png} &
\includegraphics[height=.096\textheight]{../plots/13b.png} &
14 & \includegraphics[height=.096\textheight]{../plots/14a.png} &
\includegraphics[height=.096\textheight]{../plots/14b.png} \\
15 & \includegraphics[height=.096\textheight]{../plots/15a.png} &
\includegraphics[height=.096\textheight]{../plots/15b.png} &
16 & \includegraphics[height=.096\textheight]{../plots/16a.png} &
\includegraphics[height=.096\textheight]{../plots/16b.png} \\
17 & \includegraphics[height=.096\textheight]{../plots/17a.png} &
\includegraphics[height=.096\textheight]{../plots/17b.png} &
18 & \includegraphics[height=.096\textheight]{../plots/18a.png} &
\includegraphics[height=.096\textheight]{../plots/18b.png} \\
\end{tabular}
}
